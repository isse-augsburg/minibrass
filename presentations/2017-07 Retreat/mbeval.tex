...
\begin{columns}[onlytextwidth]
    ...
    \end{column}
    \begin{column}{.45\textwidth}
    \centering \hSecond{Soft Constraint Solver Solver}
...
\node at (9.4, -2.4) {\includegraphics[width=2.3cm]{img/search-space.pdf} }; 
...
\node at (3.6, -2.4) {\includegraphics[width=.55cm]{img/search-space-weighted.pdf} }; 
