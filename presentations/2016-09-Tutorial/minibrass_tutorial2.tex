...
\begin{itemize}
\item Soft constraints can be useful especially in autonomic computing settings
\item Modeling problems independently from a solver can bring benefits
\item Let us know if you can use MiniBrass 
\end{itemize}
\begin{center}

\includegraphics[width=.4\textwidth]{img/minibrass.png}
